...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'freelancer', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\MyApp\\JobownerBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\MyApp\\FreelancerBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'MyApp\\JobownerBundle\\Entity');
        $c->addDriver($b, 'MyApp\\FreelancerBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('JobownerBundle' => 'MyApp\\JobownerBundle\\Entity', 'FreelancerBundle' => 'MyApp\\FreelancerBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_5b7cf34a576f8828687d7058603b4c1ac5a10051ffef64d0690decd135112cba');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('MyApp\\JobownerBundle\\Entity\\Utilisateurs');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('MyApp\\JobownerBundle\\Entity\\Utilisateurs');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('MyApp\\JobownerBundle\\Entity\\Utilisateurs');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('MyApp\\JobownerBundle\\Entity\\Utilisateurs');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'MyApp\\JobownerBundle\\Entity\\Utilisateurs');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/add');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/Projets');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/suppression/id');

        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('^/projetsuivi');
        ...
        $p->add($k, array(0 => 'ROLE_JOBOWNER'), NULL);
        $p->add($l, array(0 => 'ROLE_JOBOWNER'), NULL);
        $p->add($m, array(0 => 'ROLE_JOBOWNER'), NULL);
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('kasdaghli.ghassen@gmail.com');
        $a->setPassword('aa000000');
        $a->setAuthMode('login');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\MyApp\\JobownerBundle/Resources/views'), 'Jobowner');
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\MyApp\\FreelancerBundle/Resources/views'), 'Freelancer');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'JobownerBundle' => 'MyApp\\JobownerBundle\\JobownerBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'NomayaSocialBundle' => 'Nomaya\\SocialBundle\\NomayaSocialBundle',
                'KnpPaginatorBundle' => 'Knp\\Bundle\\PaginatorBundle\\KnpPaginatorBundle',
                'FreelancerBundle' => 'MyApp\\FreelancerBundle\\FreelancerBundle',
            ...
            'mailer_user' => 'kasdaghli.ghassen@gmail.com',
            'mailer_password' => 'aa000000',
            'locale' => 'fr',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'kasdaghli.ghassen@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'aa000000',
            ...
            'fos_user.model.user.class' => 'MyApp\\JobownerBundle\\Entity\\Utilisateurs',
