...
use MyApp\FreelancerBundle\Entity\Cv;
use MyApp\FreelancerBundle\Form\CvType;
...
class CvController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FreelancerBundle:Cv')->findAll();

        return $this->render('FreelancerBundle:Cv:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('FreelancerBundle:Cv:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FreelancerBundle:Cv')->find($id);
        ...
        return $this->render('FreelancerBundle:Cv:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('FreelancerBundle:Cv:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    {
        $form = $this->createForm(new CvType(), $entity, array(
            'action' => $this->generateUrl('cv_update', array('id' => $entity->getCvId())),
            'method' => 'PUT',
        ));
