...
use MyApp\FreelancerBundle\Entity\Tests;
use MyApp\FreelancerBundle\Form\TestsType;
...
class TestsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FreelancerBundle:Tests')->findAll();

        return $this->render('FreelancerBundle:Tests:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('FreelancerBundle:Tests:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FreelancerBundle:Tests')->find($id);
        ...
        return $this->render('FreelancerBundle:Tests:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('FreelancerBundle:Tests:edit.html.twig', array(
            'entity'      => $entity,
