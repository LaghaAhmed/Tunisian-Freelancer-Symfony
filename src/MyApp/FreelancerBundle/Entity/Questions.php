...
class Questions
{
     ...
     * Add test
     *
     * @param \MyApp\FreelancerBundle\Entity\Tests $test
     *
     * @return Questions
     */
    public function addTest(\MyApp\FreelancerBundle\Entity\Tests $test)
    {
        $this->test[] = $test;
     ...
     * @param \MyApp\FreelancerBundle\Entity\Tests $test
     */
    public function removeTest(\MyApp\FreelancerBundle\Entity\Tests $test)
    {
